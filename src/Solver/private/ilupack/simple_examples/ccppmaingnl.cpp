...
{
    long int      ia[9] ={   1,   5,   8,  10,  12,  13,  16,  18,  21},
                  ja[20]={   1,        3,             6,   7, 
                                  2,   3,        5,
                                       3,                       8,
                                            4,             7,
    ...
    a[ 0].i= 0.0; a[ 1].i=-1.0; a[ 2].i=-1.0; a[3].i=-1.0;

    a[ 4].r=-4.0; a[ 5].r= 8.0; a[ 6].r= 2.0;
    a[ 4].i= 0.0; a[ 5].i=-1.0; a[ 6].i=-1.0;
    ...
    a[12].r= 7.0; a[13].r= 3.0; a[14].r= 8.0;
    a[12].i=-1.0; a[13].i=-1.0; a[14].i=-1.0;

    a[15].r= 1.0; a[16].r=11.0;
    a[15].i= 0.0; a[16].i=-1.0;

    a[17].r=-3.0; a[18].r= 2.0; a[19].r= 5.0;
    a[17].i=-1.0; a[18].i=-1.0; a[19].i=-1.0;
    ...
    /* ILUPACK uses compressed sparse ROW format. 
                         /3.5 -1.0-i  0 \
       A general matrix  |2.1   2i    0 | is stored as follows
                         \ 0    0    1.5/ 

       A.ia:   1  3  5  6           pointer to the start of every compressed 
                                    row plus pointer to the first space 
				    behind the compressed rows

       A.ja:   1     2     1     2     3     nonzero column indices

       A.a:   3.5 -1.0-i  2.1    2i   1.5    nonzero numerical values
    ...
    ierr=CGNLAMGfactor(&A, &PRE, &param);
    ...
    ierr=CGNLAMGsolver(&A, &PRE, &param, rhs, sol);
