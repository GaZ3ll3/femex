...
#include "../../../ilupack/samples/spdreadmatrix.c"
    ...
    // 18. require the computation of the preconditioner in
    //     single precision
...
#include "../../../ilupack/samples/spdmessages.c"
    ...
    if (!strcmp(param.typetv,"static") || !strcmp(param.typetv,"none")) 
       ...
       // param.returnlabel=0;
       // SPDAMGINIT will do this automatically
       do {
	  ierr=SPDAMGFACTOR(&A, &PRE, &param);
...
#include "../../../ilupack/samples/spdprintperformance.c"
    ...
    */
    ...
    // param.ipar[24]=2;
    // indicate whether the initial guess is zero
    // param.ipar[33]=1;
...
#include "../../../ilupack/samples/spdinitvectors.c"
	...
	printf("initial residual: %8.1le\n",val);
	printf("target (energy norm relative to target %8.1e*||x||_A):  %8.1le\n",param.restol,param.fpar[23]);
