...
int main(int argc, char **argv)
{
    ...
    integer      i,j,k,l,m,fnamelen,n,nc,nz,nrhs,tmp0,tmp,tmp2,tmp3,ierr,nLU,
                 ...
                 mynrhs=2, transpose=0, sumit;
    double       DROP_TOL, CONDEST, ELBOW, val,vb;
    doublecomplex *rhs,*sol, *leftscale, *rightscale, *rhsval;
     ...
     */
#include "../../../ilupack/samples/readgnlmatrix.c"
