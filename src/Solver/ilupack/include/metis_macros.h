#ifndef _METIS_MACROS_H_
#define _METIS_MACROS_H_
/*
...
#else
#define RandomInRange(u) ((integer)(drand48()*((double)(u))))
#define RandomInRangeFast(u) ((rand()>>3)%(u))
#endif
...
**************************************************************************/
#ifdef DMALLOC
#define imalloc(n, msg) (malloc(sizeof(integer)*(n)))
#define fmalloc(n, msg) (malloc(sizeof(float)*(n)))
#define idxmalloc(n, msg) (malloc(sizeof(idxtype)*(n)))
#define ismalloc(n, val, msg) (iset((n), (val), malloc(sizeof(integer)*(n))))
