...
/*
    ...
    [x, options] = ZGNLDSYMilupacksolver(A,PREC,options, b,x0);
...
)
{
    ...
    A.nc=A.nr=mrows;
    A.ia=(integer *) MAlloc((size_t)(A.nc+1)*sizeof(integer),"ZGNLDSYMilupacksolver");
    A.ja=(integer *) MAlloc((size_t)nnz     *sizeof(integer),"ZGNLDSYMilupacksolver");
    A. a=(doublecomplex *) MAlloc((size_t)nnz     *sizeof(doublecomplex), "ZGNLDSYMilupacksolver");
    ...
    */
	...
	if (classIDflags[ifield] == mxCHAR_CLASS) {
	   ...
	   if (!strcmp("amg",fnames[ifield])) {
		 ...
		 param->postsmoother=(char *)MAlloc(buflen*sizeof(char),
						    "ilupacksolver");
    ...
    /* get size of input matrix A */
    rhs=(doublecomplex*) MAlloc((size_t)A.nr*sizeof(doublecomplex),"ZGNLDSYMilupacksolver:rhs");
    pr=mxGetPr(b_input);
    ...
    /* numerical solution */
    sol=(doublecomplex *)MAlloc((size_t)A.nr*sizeof(doublecomplex),"ZGNLDSYMilupacksolver:sol");
    pr=mxGetPr(x0_input);
    ...
    ierr=ZGNLDSYMAMGsolver(&A, PRE, param, rhs, sol);
