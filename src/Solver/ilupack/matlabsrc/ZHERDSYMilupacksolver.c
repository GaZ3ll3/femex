...
/*
    ...
    [x, options] = ZHERDSYMilupacksolver(A,PREC,options, b,x0);
...
)
{
    ...
    A.nc=A.nr=mrows;
    A.ia=(integer *) MAlloc((size_t)(A.nc+1)*sizeof(integer),"ZHERDSYMilupacksolver");
    A.ja=(integer *) MAlloc((size_t)nnz     *sizeof(integer),"ZHERDSYMilupacksolver");
    A. a=(doublecomplex *) MAlloc((size_t)nnz     *sizeof(doublecomplex), "ZHERDSYMilupacksolver");
    ...
    */
    ...
    /* numerical solution */
    sol=(doublecomplex *)MAlloc((size_t)A.nr*sizeof(doublecomplex),"ZHERDSYMilupacksolver:sol");
    pr=mxGetPr(x0_input);
    ...
    ierr=ZHERDSYMAMGsolver(&A, PRE, param, rhs, sol);
