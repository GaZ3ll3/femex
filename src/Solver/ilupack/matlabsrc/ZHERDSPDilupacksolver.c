...
/*
    ...
    [x, options] = ZHERDSPDilupacksolver(A,PREC,options, b,x0);
...
)
{
    ...
    mwSize     mrows, ncols, ndim, nnz, buflen;
    ...
    A.nc=A.nr=mrows;
    A.ia=(integer *) MAlloc((size_t)(A.nc+1)*sizeof(integer),"ZHERDSPDilupacksolver");
    A.ja=(integer *) MAlloc((size_t)nnz     *sizeof(integer),"ZHERDSPDilupacksolver");
    A. a=(doublecomplex *) MAlloc((size_t)nnz     *sizeof(doublecomplex), "ZHERDSPDilupacksolver");
    ...
    */
    ...
    /* get size of input matrix A */
    rhs=(doublecomplex*) MAlloc((size_t)A.nr*sizeof(doublecomplex),"ZHERilupacksolver:rhs");
    pr=mxGetPr(b_input);
    ...
    /* numerical solution */
    sol=(doublecomplex *)MAlloc((size_t)A.nr*sizeof(doublecomplex),"ZHERDSPDilupacksolver:sol");
    pr=mxGetPr(x0_input);
    ...
    ierr=ZHERDSPDAMGsolver(&A, PRE, param, rhs, sol);
