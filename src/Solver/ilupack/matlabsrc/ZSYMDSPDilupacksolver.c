...
/*
    ...
    [x, options] = ZSYMDSPDilupacksolver(A,PREC,options, b,x0);
...
)
{
    ...
    A.nc=A.nr=mrows;
    A.ia=(integer *) MAlloc((size_t)(A.nc+1)*sizeof(integer),"ZSYMDSPDilupacksolver");
    A.ja=(integer *) MAlloc((size_t)nnz     *sizeof(integer),"ZSYMDSPDilupacksolver");
    A. a=(doublecomplex *) MAlloc((size_t)nnz     *sizeof(doublecomplex), "ZSYMDSPDilupacksolver");
    ...
    */
    ...
    /* get size of input matrix A */
    rhs=(doublecomplex*) MAlloc((size_t)A.nr*sizeof(doublecomplex),"ZSYMDSPDilupacksolver:rhs");
    pr=mxGetPr(b_input);
    ...
    /* numerical solution */
    sol=(doublecomplex *)MAlloc((size_t)A.nr*sizeof(doublecomplex),"ZSYMDSPDilupacksolver:sol");
    pr=mxGetPr(x0_input);
    ...
    ierr=ZSYMDSPDAMGsolver(&A, PRE,param, rhs, sol);
