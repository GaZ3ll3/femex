...
/*
    ...
    [x, options] = ZHERilupacksolver(A,PREC,options, b,x0);
...
)
{
    ...
    A.nc=A.nr=mrows;
    A.ia=(integer *) MAlloc((size_t)(A.nc+1)*sizeof(integer),"ZHERilupacksolver");
    A.ja=(integer *) MAlloc((size_t)nnz     *sizeof(integer),"ZHERilupacksolver");
    A. a=(doublecomplex *) MAlloc((size_t)nnz     *sizeof(doublecomplex), "ZHERilupacksolver");
    ...
    */
    ...
    /* numerical solution */
    sol=(doublecomplex *)MAlloc((size_t)A.nr*sizeof(doublecomplex),"ZHERilupacksolver:sol");
    pr=mxGetPr(x0_input);
    ...
    ierr=ZHERAMGsolver(&A, PRE, param, rhs, sol);
