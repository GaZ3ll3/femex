...
/*
    ...
    [x, options] = DSYMSPDilupacksolver(A,PREC,options, b,x0);
...
)
{
    ...
    A.nc=A.nr=mrows;
    A.ia=(integer *) MAlloc((size_t)(A.nc+1)*sizeof(integer),"DSYMSPDilupackfactor");
    A.ja=(integer *) MAlloc((size_t)nnz     *sizeof(integer),"DSYMSPDilupackfactor");
    A. a=(double  *) MAlloc((size_t)nnz     *sizeof(double), "DSYMSPDilupackfactor");
    ...
    */
    ...
    classIDflags = (mxClassID *) mxCalloc((size_t)nfields+1, (size_t)sizeof(int));
    ...
    /* get size of input matrix A */
    rhs=(double*) MAlloc((size_t)A.nr*sizeof(double),"DSYMSPDilupacksolver:rhs");
    pr=mxGetPr(b_input);
    ...
    /* numerical solution */
    sol=(double *)MAlloc((size_t)A.nr*sizeof(double),"DSYMSPDilupackfactor:sol");
    pr=mxGetPr(x0_input);
    memcpy(sol,pr,(size_t)A.nr*sizeof(double));



    ierr=DSYMSPDAMGsolver(&A, PRE, param, rhs, sol);
