...
)
{
    ...
    A.nc=ncols;
    A.nr=mrows;
    A.ia=(integer *)      MAlloc((size_t)(A.nc+1)*sizeof(integer),       "ZGNLilupackfactor");
    A.ja=(integer *)      MAlloc((size_t)nnz     *sizeof(integer),       "ZGNLilupackfactor");
    A.a =(doublecomplex*) MAlloc((size_t)nnz     *sizeof(doublecomplex), "ZGNLilupackfactor");
    ...
    */
    ...
    rhs=(doublecomplex*)MAlloc((size_t)i*sizeof(doublecomplex),"ZGNLsavehbo:rhs");
    sol=rhs;
    tname[0]=' ';
    tname[1]=' ';
    tname[2]=' ';
    ...
    Zwritemtc(fname,A.a,A.ja,A.ia,rhs,&ncolumns,
	      tname,&(A.nr),&(A.nc),&m,
	      "ILUPACK toolbox for MATLAB. Export routine to Harwell-Boeing format     ",fname2,"cua",strlen(fname),3,72,8,3);
