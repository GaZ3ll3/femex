...
)
{
    ...
    double     *A_valuesR, *pr, *sol, *rhs, *x0;
    ...
    */
    ...
    rhs=(double *) MAlloc((size_t)i*sizeof(double),"DSYMsavehbo:rhs");
    sol=rhs;
    tname[0]=' ';
    tname[1]=' ';
    tname[2]=' ';
	...
	*sol++=*pr++;
    ...
    ncolumns=ncols;
    m=nnz;
    Dwritemtc(fname,A.a,A.ja,A.ia,rhs,&ncolumns,
	      tname,&(A.nr),&(A.nc),&m,
	      "ILUPACK toolbox for MATLAB. Export routine to Harwell-Boeing format     ",fname2,"rua",strlen(fname),3,72,8,3);
