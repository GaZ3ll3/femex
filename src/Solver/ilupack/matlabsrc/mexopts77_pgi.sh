...
#
            LD="$FC"
            LDEXTENSION='.mexglx'
            LDFLAGS="-Mnomain -shared -Wl,--version-script,$TMW_ROOT/extern/lib/$Arch/$MAPFILE -Wl,--no-undefined"
            LDOPTIMFLAGS='-O'
            LDDEBUGFLAGS='-g'
#
            POSTLINK_CMDS=':'
...
#----------------------------------------------------------------------------
            ...
            # CkeyVersion:
            CC='pgcc'
            CFLAGS=' -B -Mlarge_arrays -fPIC -c89 '
            CFLAGS="$CFLAGS "
            CFLAGS="$CFLAGS"
            CLIBS="$RPATH $MLIBS"
            COPTIMFLAGS='-O -DNDEBUG'
...
#
            ...
            # C++keyVersion: 
            CXX='pgCC'
            CXXFLAGS='-O -B -Mlarge_arrays -fPIC -c89'
            CXXFLAGS="$CXXFLAGS"
            CXXLIBS="$RPATH $MLIBS"
            CXXOPTIMFLAGS='-O -DNDEBUG'
            CXXDEBUGFLAGS='-g'
...
#
            FC='pgf90'
            FFLAGS=' -Mextend -Mlarge_arrays -i8 -fPIC '
            FFLAGS="$FFLAGS"
            FLIBS="$RPATH $MLIBS"
            FOPTIMFLAGS='-O'
            FDEBUGFLAGS='-g'
