...
/*
    ...
    [x, options] = ZSYMilupacksolver(A,PREC, b, options);
...
)
{
    ...
    mxArray    *tmp, *fout, *A_input , *b_input, *x0_input, *x_output, 
               *options_input, *PRE_input, *options_output;
    ...
    A.nc=A.nr=mrows;
    A.ia=(integer *) MAlloc((size_t)(A.nc+1)*sizeof(integer),"ZSYMilupacksolver");
    A.ja=(integer *) MAlloc((size_t)nnz     *sizeof(integer),"ZSYMilupacksolver");
    A.a =(doublecomplex *) MAlloc((size_t)nnz     *sizeof(doublecomplex), "ZSYMilupacksolver");
    ...
    */
    ...
    sol=(doublecomplex *)MAlloc((size_t)A.nr*sizeof(doublecomplex),"ZSYMilupacksolver:sol");
    pr=mxGetPr(x0_input);
    ...
    ierr=ZSYMAMGsolver(&A, PRE, param, rhs, sol);
