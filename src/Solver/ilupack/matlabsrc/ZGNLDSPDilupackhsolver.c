...
/*
    ...
    [x, options] = ZGNLDSPDilupacksolver(A,PREC,options, b,x0);
...
)
{
    ...
    A.nc=A.nr=mrows;
    A.ia=(integer *) MAlloc((size_t)(A.nc+1)*sizeof(integer),"ZGNLDSPDilupacksolver");
    A.ja=(integer *) MAlloc((size_t)nnz     *sizeof(integer),"ZGNLDSPDilupacksolver");
    A. a=(doublecomplex *) MAlloc((size_t)nnz     *sizeof(doublecomplex), "ZGNLDSPDilupacksolver");
    ...
    */
    ...
    /* numerical solution */
    sol=(doublecomplex *)MAlloc((size_t)A.nr*sizeof(doublecomplex),"ZGNLDSPDilupacksolver:sol");
    pr=mxGetPr(x0_input);
    ...
    /* set bit 3, conjugate */
    param->ipar[4]|=8;
    ierr=ZGNLDSPDAMGsolver(&A, PRE, param, rhs, sol);
