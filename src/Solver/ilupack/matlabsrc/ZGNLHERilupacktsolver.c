...
/*
    ...
    [x, options] = ZGNLHERilupacksolver(A,PREC,options, b,x0);
...
)
{
    ...
    A.nc=A.nr=mrows;
    A.ia=(integer *) MAlloc((size_t)(A.nc+1)*sizeof(integer),"ZGNLHERilupacksolver");
    A.ja=(integer *) MAlloc((size_t)nnz     *sizeof(integer),"ZGNLHERilupacksolver");
    A. a=(doublecomplex *) MAlloc((size_t)nnz     *sizeof(doublecomplex), "ZGNLHERilupacksolver");
    ...
    */
    ...
    /* get size of input matrix A */
    rhs=(doublecomplex*) MAlloc((size_t)A.nr*sizeof(doublecomplex),"ZGNLHERilupacksolver:rhs");
    pr=mxGetPr(b_input);
    ...
    /* numerical solution */
    sol=(doublecomplex *)MAlloc((size_t)A.nr*sizeof(doublecomplex),"ZGNLHERilupacksolver:sol");
    pr=mxGetPr(x0_input);
    ...
    /* set bit 3, conjugate */
    param->ipar[4]|=0;
    ierr=ZGNLHERAMGsolver(&A, PRE, param, rhs, sol);
    ...
    if (j==-1)
       ...
       ifield=j;
    fout=mxCreateDoubleMatrix((mwSize)1,(mwIndex)1, mxREAL);
    pr=mxGetPr(fout);
