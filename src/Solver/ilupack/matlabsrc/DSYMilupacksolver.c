...
/*
    ...
    [x, options] = DSYMilupacksolver(A,PREC,options, b,x0);
...
)
{
    ...
    mxArray    *tmp, *fout, *A_input , *PRE_input, *options_input, *b_input,
               *x0_input, *x_output, *options_output;
    ...
    A.nc=A.nr=mrows;
    A.ia=(integer *) MAlloc((size_t)(A.nc+1)*sizeof(integer),"DSYMilupacksolver");
    A.ja=(integer *) MAlloc((size_t)nnz     *sizeof(integer),"DSYMilupacksolver");
    A. a=(double  *) MAlloc((size_t)nnz     *sizeof(double), "DSYMilupacksolver");
    ...
    */
    ...
    /* get size of input matrix A */
    rhs=(double*) MAlloc((size_t)A.nr*sizeof(double),"DSYMilupacksolver:rhs");
    pr=mxGetPr(b_input);
    ...
    /* numerical solution */
    sol=(double *)MAlloc((size_t)A.nr*sizeof(double),"DSYMilupacksolver:sol");
    pr=mxGetPr(x0_input);
    memcpy(sol,pr,(size_t)A.nr*sizeof(double));



    ierr=DSYMAMGsolver(&A, PRE, param, rhs, sol);
