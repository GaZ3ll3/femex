...
int main(int argc, char **argv)
{
    ...
    /* ILUPACK uses compressed sparse ROW format. 
                           / 3.5 -1.0  0 \
       A symmetric matrix  |-1.0  2.0  0 | is stored as follows
                           \  0    0  1.5/ 
    ...
    ierr=SSPDAMGfactor(&A, &PRE, &param);
    ...
    ierr=SSPDAMGsolver(&A, &PRE, &param, rhs, sol);
