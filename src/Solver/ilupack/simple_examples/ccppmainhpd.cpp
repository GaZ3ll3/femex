...
int main(int argc, char **argv)
{
    ...
    /* initialize matrix*/
    a[ 0].r=17.0; a[ 1].r= 1.0; a[ 2].r= 2.0; a[3].r= 5.0;
    a[ 0].i= 0.0; a[ 1].i=-1.0; a[ 2].i=-1.0; a[3].i=-1.0;

    a[ 4].r= 8.0; a[ 5].r= 4.0; a[ 6].r= 2.0;
    a[ 4].i= 0.0; a[ 5].i=-1.0; a[ 6].i=-1.0;

    a[ 7].r= 7.0; a[ 8].r= 1.0;
    a[ 7].i= 0.0; a[ 8].i=-1.0;

    a[ 9].r= 4.0; a[10].r= 1.0;
    a[ 9].i= 0.0; a[10].i=-1.0;

    a[11].r= 7.0; a[12].r= 1.0; a[13].r= 5.0;
    a[11].i= 0.0; a[12].i=-1.0; a[13].i=-1.0;

    a[14].r= 6.0; a[15].r= 5.0;
    ...
    /* ILUPACK uses compressed sparse ROW format. 
                           / 3.5   -1.0-i  0 \
       A Hermitian matrix  |-1.0+i  2.0    0 | is stored as follows
                           \   0      0   1.5/ 
       ...
       A.a:   3.5 -1.0-i  2.0   1.5    nonzero numerical values
    ...
    ierr=CHPDAMGfactor(&A, &PRE, &param);
    ...
    ierr=CHPDAMGsolver(&A, &PRE, &param, rhs, sol);
