...
class kernel_RadfmmSS: public kernel_Base {
public:
...
double kernel_RadfmmSS::kernel_Func(Point r0, Point r1){
    ...
    if (rSquare == 0){
        ...
        return exp(-this->integral(r0.x, r0.y, r1.x, r1.y)) * (r0.y - r1.y)*(r0.y - r1.y)/rSquare/rSquare/rSquare/(2*M_PI)/side/side;
    }
}

double kernel_RadfmmSS::getAttribute(double x, double y) {
...
template class mexplus::Session<kernel_RadfmmSS>;
...
MEX_DEFINE(new)(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[]){
	...
	output.set(0, Session<kernel_RadfmmSS>::create(new kernel_RadfmmSS()));
...
MEX_DEFINE(delete) (int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[]) {
	...
	Session<kernel_RadfmmSS>::destroy(input.get(0));
}
...
MEX_DEFINE(calc_cache) (int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[]) {
	...
	auto kern = Session<kernel_RadfmmSS>::get(input.get(0));
