...
class kernel_RadfmmUU: public kernel_Base {
public:
...
double kernel_RadfmmUU::kernel_Func(Point r0, Point r1){
...
double kernel_RadfmmUU::getAttribute(double x, double y) {
...
template class mexplus::Session<kernel_RadfmmUU>;
...
MEX_DEFINE(new)(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[]){
	...
	output.set(0, Session<kernel_RadfmmUU>::create(new kernel_RadfmmUU()));
...
MEX_DEFINE(delete) (int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[]) {
	...
	Session<kernel_RadfmmUU>::destroy(input.get(0));
}
...
MEX_DEFINE(calc_cache) (int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[]) {
	...
	auto kern = Session<kernel_RadfmmUU>::get(input.get(0));
