...
class kernel_RadfmmUS: public kernel_Base {
public:
...
double kernel_RadfmmUS::kernel_Func(Point r0, Point r1){
    double rSquare	= distance(r0.x, r0.y, r1.x, r1.y) ;
    if (rSquare == 0){
    	return 0.;
    }
    else{
        return exp(-this->integral(r0.x, r0.y, r1.x, r1.y)) * (r0.x - r1.x)/rSquare/rSquare/(2*M_PI)/side/side;
    }
}

double kernel_RadfmmUS::getAttribute(double x, double y) {
...
template class mexplus::Session<kernel_RadfmmUS>;
...
MEX_DEFINE(new)(int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[]){
	...
	output.set(0, Session<kernel_RadfmmUS>::create(new kernel_RadfmmUS()));
...
MEX_DEFINE(delete) (int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[]) {
	...
	Session<kernel_RadfmmUS>::destroy(input.get(0));
}
...
MEX_DEFINE(calc_cache) (int nlhs, mxArray* plhs[], int nrhs, const mxArray* prhs[]) {
	...
	auto kern = Session<kernel_RadfmmUS>::get(input.get(0));
